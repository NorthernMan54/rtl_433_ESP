...
*/
  ...
  logprintf(LOG_INFO, "# of device(s) configured %d", cfg->num_r_devices);
  logprintf(LOG_INFO, "ssizeof(r_device): %d", sizeof(r_device));
  logprintf(LOG_INFO, "ssizeof(r_devices): %d", sizeof(r_device) * cfg->num_r_devices);
  logprintf(LOG_INFO, "Location of cfg: %p", (void *)&cfg);
  logprintf(LOG_INFO, "cfg size %d", sizeof(r_cfg_t));
  logprintf(LOG_INFO, "ssizeof(cfg->devices): %d", sizeof(cfg->devices));
  logprintf(LOG_INFO, "Location of cfg->devices: %p", (void *)&cfg->devices);
  logprintf(LOG_INFO, "size of bitbuffer: %d", sizeof(bitbuffer_t));
  logprintf(LOG_INFO, "size of pulse_data: %d", sizeof(pulse_data_t));
