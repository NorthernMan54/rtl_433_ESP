...
if (rtl_433_ESP::ookModulation) {
  ...
  memcpy(&cfg->devices[117], &rubicson, sizeof(r_device));
  memcpy(&cfg->devices[118], &rubicson_48659, sizeof(r_device));
  memcpy(&cfg->devices[119], &rubicson_pool_48942, sizeof(r_device));
  memcpy(&cfg->devices[120], &s3318p, sizeof(r_device));
  memcpy(&cfg->devices[121], &schou_72543_rain, sizeof(r_device));
  memcpy(&cfg->devices[122], &schraeder, sizeof(r_device));
  memcpy(&cfg->devices[123], &schrader_EG53MA4, sizeof(r_device));
  memcpy(&cfg->devices[124], &schrader_SMD3MA4, sizeof(r_device));
  memcpy(&cfg->devices[125], &scmplus, sizeof(r_device));
