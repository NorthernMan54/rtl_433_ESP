...
#else
#  if OOK_MODULATION
#    define rtl_433_Decoder_Stack 22000
#  else
...
void rtlSetup() {
  ...
  if (!cfg->demod) {
    ...
    if (rtl_433_ESP::ookModulation) {
      ...
      memcpy(&cfg->devices[94], &nexus, sizeof(r_device));
      memcpy(&cfg->devices[95], &nice_flor_s, sizeof(r_device));
      memcpy(&cfg->devices[96], &norgo, sizeof(r_device));
      memcpy(&cfg->devices[97], &opus_xt300, sizeof(r_device));
      memcpy(&cfg->devices[98], &oregon_scientific, sizeof(r_device));
      memcpy(&cfg->devices[99], &oregon_scientific_sl109h, sizeof(r_device));
      memcpy(&cfg->devices[100], &oregon_scientific_v1, sizeof(r_device));
      memcpy(&cfg->devices[101], &philips_aj3650, sizeof(r_device));
      memcpy(&cfg->devices[102], &philips_aj7010, sizeof(r_device));
      memcpy(&cfg->devices[103], &proflame2, sizeof(r_device));
      memcpy(&cfg->devices[104], &prologue, sizeof(r_device));
      memcpy(&cfg->devices[105], &quhwa, sizeof(r_device));
      memcpy(&cfg->devices[106], &radiohead_ask, sizeof(r_device));
      memcpy(&cfg->devices[107], &sensible_living, sizeof(r_device));
      memcpy(&cfg->devices[108], &rainpoint, sizeof(r_device));
      memcpy(&cfg->devices[109], &regency_fan, sizeof(r_device));
      memcpy(&cfg->devices[110], &revolt_nc5462, sizeof(r_device));
      memcpy(&cfg->devices[111], &rftech, sizeof(r_device));
      memcpy(&cfg->devices[112], &rubicson, sizeof(r_device));
      memcpy(&cfg->devices[113], &rubicson_48659, sizeof(r_device));
      memcpy(&cfg->devices[114], &rubicson_pool_48942, sizeof(r_device));
      memcpy(&cfg->devices[115], &s3318p, sizeof(r_device));
      memcpy(&cfg->devices[116], &schraeder, sizeof(r_device));
      memcpy(&cfg->devices[117], &schrader_EG53MA4, sizeof(r_device));
      memcpy(&cfg->devices[118], &schrader_SMD3MA4, sizeof(r_device));
      memcpy(&cfg->devices[119], &scmplus, sizeof(r_device));
      memcpy(&cfg->devices[120], &secplus_v1, sizeof(r_device));
      memcpy(&cfg->devices[121], &secplus_v2, sizeof(r_device));
      memcpy(&cfg->devices[122], &silvercrest, sizeof(r_device));
      memcpy(&cfg->devices[123], &ss_sensor, sizeof(r_device));
      memcpy(&cfg->devices[124], &skylink_motion, sizeof(r_device));
      memcpy(&cfg->devices[125], &smoke_gs558, sizeof(r_device));
      memcpy(&cfg->devices[126], &solight_te44, sizeof(r_device));
      memcpy(&cfg->devices[127], &somfy_rts, sizeof(r_device));
      memcpy(&cfg->devices[128], &springfield, sizeof(r_device));
      memcpy(&cfg->devices[129], &telldus_ft0385r, sizeof(r_device));
      memcpy(&cfg->devices[130], &tfa_30_3221, sizeof(r_device));
      memcpy(&cfg->devices[131], &tfa_drop_303233, sizeof(r_device));
      memcpy(&cfg->devices[132], &tfa_pool_thermometer, sizeof(r_device));
      memcpy(&cfg->devices[133], &tfa_twin_plus_303049, sizeof(r_device));
      memcpy(&cfg->devices[134], &thermopro_tp11, sizeof(r_device));
      memcpy(&cfg->devices[135], &thermopro_tp12, sizeof(r_device));
      memcpy(&cfg->devices[136], &thermopro_tx2, sizeof(r_device));
      memcpy(&cfg->devices[137], &tpms_eezrv, sizeof(r_device));
      memcpy(&cfg->devices[138], &tpms_tyreguard400, sizeof(r_device));
      memcpy(&cfg->devices[139], &ts_ft002, sizeof(r_device));
      memcpy(&cfg->devices[140], &ttx201, sizeof(r_device));
      memcpy(&cfg->devices[141], &vaillant_vrt340f, sizeof(r_device));
      memcpy(&cfg->devices[142], &vauno_en8822c, sizeof(r_device));
      memcpy(&cfg->devices[143], &visonic_powercode, sizeof(r_device));
      memcpy(&cfg->devices[144], &waveman, sizeof(r_device));
      memcpy(&cfg->devices[145], &wec2103, sizeof(r_device));
      memcpy(&cfg->devices[146], &wg_pb12v1, sizeof(r_device));
      memcpy(&cfg->devices[147], &ws2032, sizeof(r_device));
      memcpy(&cfg->devices[148], &wssensor, sizeof(r_device));
      memcpy(&cfg->devices[149], &wt1024, sizeof(r_device));
      memcpy(&cfg->devices[150], &wt450, sizeof(r_device));
      memcpy(&cfg->devices[151], &X10_RF, sizeof(r_device));
      memcpy(&cfg->devices[152], &x10_sec, sizeof(r_device));
      memcpy(&cfg->devices[153], &yale_hsa, sizeof(r_device));
    } else {
      ...
      memcpy(&cfg->devices[46], &sharp_spc775, sizeof(r_device));
      memcpy(&cfg->devices[47], &simplisafe_gen3, sizeof(r_device));
      memcpy(&cfg->devices[48], &somfy_iohc, sizeof(r_device));
      memcpy(&cfg->devices[49], &srsmith_pool_srs_2c_tx, sizeof(r_device));
      memcpy(&cfg->devices[50], &steelmate, sizeof(r_device));
      memcpy(&cfg->devices[51], &tfa_14_1504_v2, sizeof(r_device));
      memcpy(&cfg->devices[52], &tfa_303196, sizeof(r_device));
      memcpy(&cfg->devices[53], &tfa_marbella, sizeof(r_device));
      memcpy(&cfg->devices[54], &tpms_ave, sizeof(r_device));
      memcpy(&cfg->devices[55], &tpms_hyundai_vdo, sizeof(r_device));
      memcpy(&cfg->devices[56], &tpms_kia, sizeof(r_device));
      memcpy(&cfg->devices[57], &tpms_porsche, sizeof(r_device));
      memcpy(&cfg->devices[58], &tpms_renault_0435r, sizeof(r_device));
      memcpy(&cfg->devices[59], &tpms_truck, sizeof(r_device));
    }
